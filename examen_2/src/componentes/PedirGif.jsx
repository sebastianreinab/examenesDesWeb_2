...
export const PedirGif = ({gif}) => {
    ...
    const getGifs = async() => {
        ...
        const url=`https://api.giphy.com/v1/gifs/search?api_key=WkQFOUPuewhrmtUpLoiwZAFFKzKoCiAJ&q=${gif}&limit=25&offset=0&rating=g&lang=en&bundle=messaging_non_clips`
